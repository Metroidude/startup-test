...
const testimonialData: Testimonial[] = [
  {
    id: 1,
    name: "Spencer B.",
    designation: "Cedarville University, Class of '23",
    content:
    ...
    image: "/images/testimonials/spencer.jpg",
    star: 5,
  },
];
  ...
  return (
    <section className="relative z-10 bg-primary/[.03] py-16 md:py-20 lg:py-28">
      <div className="container">
        ...
        <div className="grid justify-items-center grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
